# examples/ch-24-pipeline.py
# Handbook chapter: 流水线编排 (Pipeline) — PipelineBuilder + ExecutionEngine
#
...
CHAPTER_SLUG = "ch-24-pipeline"
CHAPTER_TITLE = "流水线编排 (Pipeline) — PipelineBuilder + ExecutionEngine"
