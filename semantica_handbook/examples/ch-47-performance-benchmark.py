# examples/ch-47-performance-benchmark.py
# Handbook chapter: 性能基准 — Benchmarks Suite
#
...
CHAPTER_SLUG = "ch-47-performance-benchmark"
CHAPTER_TITLE = "性能基准 — Benchmarks Suite"
