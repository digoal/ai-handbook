# examples/ch-36-triple-stores-compat.py
# Handbook chapter: Triple Stores 适配矩阵 — 5 家
#
...
CHAPTER_SLUG = "ch-36-triple-stores-compat"
CHAPTER_TITLE = "Triple Stores 适配矩阵 — 5 家"
