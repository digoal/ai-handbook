# examples/ch-45-cloud-platforms.py
# Handbook chapter: 云平台模板 — Azure / Fly / GCP / Railway / Render
#
...
CHAPTER_SLUG = "ch-45-cloud-platforms"
CHAPTER_TITLE = "云平台模板 — Azure / Fly / GCP / Railway / Render"
