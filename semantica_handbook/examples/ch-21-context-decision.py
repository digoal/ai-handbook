# examples/ch-21-context-decision.py
# Handbook chapter: 上下文与决策智能 (Context & Decision)
#
...
CHAPTER_SLUG = "ch-21-context-decision"
CHAPTER_TITLE = "上下文与决策智能 (Context & Decision)"
