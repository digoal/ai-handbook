# examples/ch-50-cookbook-index.py
# Handbook chapter: Cookbook 索引 — 37 个 notebook 导航
#
...
CHAPTER_SLUG = "ch-50-cookbook-index"
CHAPTER_TITLE = "Cookbook 索引 — 37 个 notebook 导航"
