# examples/ch-26-visualization-export.py
# Handbook chapter: 可视化与导出 (Visualization & Export)
#
...
CHAPTER_SLUG = "ch-26-visualization-export"
CHAPTER_TITLE = "可视化与导出 (Visualization & Export)"
